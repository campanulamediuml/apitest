...
#     line = [config.access_token,json_line['main_image'],'D.Va_test_2','just_a_test_item','test,d.va,overwatch','T_DVa_get_test','10','9999','100','https://static.zerochan.net/D.Va.full.2024803.jpg','DVa_test_get_test']
#     item_line = []
#     for i in line:
#         item_line.append(quote(i))
#     item_line = tuple(item_line)
#     #print item_line
#     url = "https://merchant.wish.com/api/v2/product/add?access_token=%s&main_image=%s&name=%s&description=%s&tags=%s&sku=%s&inventory=%s&price=%s&shipping=%s&extra_images=%s&parent_sku=%s"%item_line
#     r = requests.post(url)
#     print r.text
