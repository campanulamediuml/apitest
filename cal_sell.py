#coding=utf-8
dic = {3.0:30.0,7.0:65.0,14.0:130.0,30.0:260.0}
...
def get_i_30(day_list):
    ...
    increase_expect = increase_expect/count
    ...
    #计算每个周期的增长率的平均数
    other_expect = other_expect/count
    print count
    ...
    #计算平均增长率
    sell_expect = (increase_expect * other_expect)/4
